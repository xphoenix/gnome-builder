...
{
  self->settings_sandwich = egg_settings_sandwich_new ();
}
 ...
 * @get_mapping: (allow-none) (call async): variant to value mapping
 * @set_mapping: (allow-none) (call async): value to variant mapping
