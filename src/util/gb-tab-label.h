...
GtkWidget   *gb_tab_label_new              (const gchar *label);
GtkWidget   *gb_tab_label_get_custom_title (GbTabLabel  *label);
void         gb_tab_label_set_custom_title (GbTabLabel  *label,
                                            GtkWidget   *custom_title);
void         gb_tab_label_set_modified     (GbTabLabel  *label,
                                            gboolean     modified);
gboolean     gb_tab_label_get_modified     (GbTabLabel  *label);
const gchar *gb_tab_label_get_title        (GbTabLabel  *label);
void         gb_tab_label_set_title        (GbTabLabel  *label,
                                            const gchar *title);
